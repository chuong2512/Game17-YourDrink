...
public class LiquidManager : MonoBehaviour
{
    ...
    {
        var color = GameDataManager.Instance.drinkSo
            .GetWaterWithID(GameDataManager.Instance.playerData.currentID).color;

        ZibraLiquidMaterial.Color = color;
        ZibraLiquidMaterial.ReflectionColor = color;
        ZibraLiquidMaterial.EmissiveColor = color;
    }
