...
public class IAPKey
{
    public const string PACK1 = "your_drink_app_pack_1";
    public const string PACK2 = "your_drink_app_pack_2";
    public const string PACK3 = "your_drink_app_pack_3";
    public const string PACK4 = "your_drink_app_pack_4";
    public const string PACK5 = "your_drink_app_pack_5";
    public const string PACK6 = "your_drink_app_pack_6";

    public const string PACK1_REGISTER = "your_drink_app_pack_register_1";
    public const string PACK2_REGISTER = "your_drink_app_pack_register_2";
    public const string PACK3_REGISTER = "your_drink_app_pack_register_3";
    public const string PACK4_REGISTER = "your_drink_app_pack_register_4";
    public const string PACK5_REGISTER = "your_drink_app_pack_register_5";
}
