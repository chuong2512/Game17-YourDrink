...
public class IAPKey
{
    public const string PACK1 = "funny_video_package_1";
    public const string PACK2 = "funny_video_package_2";
    public const string PACK3 = "funny_video_package_3";
    public const string PACK4 = "funny_video_package_4";
    public const string PACK5 = "funny_video_package_5";
    public const string PACK6 = "funny_video_package_6";

    public const string PACK1_REGISTER = "funny_video_package_register_1";
    public const string PACK2_REGISTER = "funny_video_package_register_2";
    public const string PACK3_REGISTER = "funny_video_package_register_3";
    public const string PACK4_REGISTER = "funny_video_package_register_4";
    public const string PACK5_REGISTER = "funny_video_package_register_5";
}
